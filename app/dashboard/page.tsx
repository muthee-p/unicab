	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-between">
			...
			<div className='sm_column justify-between gap-4'>
				<Link href='/dashboard'
				className='bg-teal-100 p-4 flex flex-col justify-center gap-4 rounded-lg w-48 md:h-48 items-center'> 
					<h4>Rides</h4>
				...
				<Link href='/dashboard'
				className='bg-blue-100 p-4 flex flex-col justify-center gap-4 rounded-lg w-48 items-center'> 
